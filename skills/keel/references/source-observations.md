...
| **Pricing inversion** | After controlling product, safety, security, privacy, or compliance requirements are accounted for, avoidable cost still selects the bypass under deadline and each successful bypass lowers the social cost of the next. Discipline cannot outrun economics. | 7 |
